...
本目录保存第 8 章《让 dsh 制作短剧》案例《纸箱小屋》的完整制作产物与提示词。案例使用 [drama-skills](https://github.com/worldwonderer/drama-skills) 配合 dsh，从一句话故事开始，完成剧本、资产设定、分镜、视频提示词，确认后逐镜生成视频，再合成发布。所有视频均由火山方舟 Seedance 2.0 mini 真实生成。

## 目录结构

```text
chapter8-drama-design/
├── README.md                  本说明
...
- 项目状态可用 drama-skills 的命令查看：`python <技能目录>/scripts/project_tool.py status demo/chapter8-drama-design`。
- `prompts/` 中使用的项目路径为 `demo/chapter8`；在本仓库中复用时，请按当前存档目录调整路径。
