...
![概念图生成、评分与 Skill 更新循环](assets/chapter14/14-1-01-evolution-loop.svg){.book-technical-figure width=72%}
...
![第3轮的毛色分明显上升后，dsh 立即修改绘画 Skill](assets/chapter14/14-2-01-dsh-run09.png){width=88%}
...
![概念图实验从橘猫起步，逐步找到白色狗并继续调整画面细节](assets/chapter14/14-2-06-score-evolution.png){width=94%}
