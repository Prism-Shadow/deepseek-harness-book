# 让 dsh 通过自进化画出概念图 {#ch-13}

在进入案例之前，让我们先介绍一下自进化这个概念。Agent 执行任务时会和环境交互，并从用户或者环境中获得反馈。它根据反馈分析问题，并修改自身，以达到更好的效果。这个过程就称之为自进化。

自进化通常包括下面几个步骤：

![Agent 根据反馈分析问题并修改自身](assets/chapter13/13-0-01-self-evolution-loop.svg){.book-technical-figure width=68%}
...
![概念图绘制、评分与 Skill 更新流程](assets/chapter13/13-1-01-evolution-loop.svg){.book-technical-figure width=72%}
...
![概念图实验从橘猫起步，逐步找到白色狗并继续调整画面细节](assets/chapter13/13-2-06-score-evolution.png){width=94%}
...
![第3轮的毛色分明显上升后，dsh 立即修改绘画 Skill](assets/chapter13/13-2-01-dsh-run09.png){width=88%}
...
![第0轮的橘猫](assets/chapter13/13-2-02-round00.png){.book-figure-image width=88%}
<span class="book-figure-note">第0轮｜橘猫｜19.73 分</span>
</div>

<div class="book-figure-item" markdown>
![第1轮的橘色狗](assets/chapter13/13-2-03-round01.png){.book-figure-image width=88%}
<span class="book-figure-note">第1轮｜橘色狗｜33.16 分</span>
</div>

<div class="book-figure-item" markdown>
![第3轮的白色狗](assets/chapter13/13-2-04-round03.png){.book-figure-image width=88%}
<span class="book-figure-note">第3轮｜白色狗｜68.57 分</span>
</div>

<div class="book-figure-item" markdown>
![第8轮的白色狗与简单道具](assets/chapter13/13-2-05-round08.png){.book-figure-image width=88%}
...
<div class="book-figure-item" markdown>
![第8轮的最高分概念图](assets/chapter13/13-2-05-round08.png){.book-figure-image width=88%}
<span class="book-figure-note">第8轮的最高分概念图</span>
</div>

<div class="book-figure-item" markdown>
![新会话复用 Skill 的结果](assets/chapter13/13-2-07-skill-reuse.png){.book-figure-image width=88%}
