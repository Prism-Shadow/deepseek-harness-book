...
图 9-7 是根据修正后的“backtest/backtest_report.md”和“results_summary.md”整理的结果卡。36 个完整持有区间中，只有 12 个取得正收益，段胜率为 33.3%。策略期末净值为 0.9186，年化收益率为 -0.57%，最大回撤为 -59.82%。同期持续持有的期末净值为 1.8857，年化收益率为 4.40%，最大回撤为 -57.85%。
