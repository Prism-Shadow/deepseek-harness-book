...
![首次任务完成后给出的指数选择](assets/chapter9/9-1-01-first-request.png){width=72%}
...
![行情数据修复后的复检结果](assets/chapter9/9-1-03-validation-results.png){width=74%}
...
![从规则文件整理出的 20/60 日均线核对卡](assets/chapter9/9-2-02-rule-specification.png){width=74%}
...
![日报在盘中只采用最近完整交易日](assets/chapter9/9-4-01-daily-cutoff.png){width=76%}
