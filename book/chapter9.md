...
![两只股票的规则状态、短期判断及改变条件](assets/chapter9/9-4-03-stock-analysis-overview-v2.png){width=96%}

结果卡把通富微电概括为“短期震荡”。它的 20/60 日均线仍为空头，个股与半导体板块近 20 日均下跌，资金也处于净流出状态。公开报道提到业绩预增和 AMD 合作，报告只将这些消息作为背景。ATR 占收盘价 8.4%，日内波动较高。若价格放量站上 MA60 的 67.05，且 20/60 日均线重新形成金叉，判断才转强。

紫金矿业的结果卡写为“短期震荡偏强”。其 20/60 日均线保持多头，收盘价仍在 MA60 和 MA120 上方，有色指数、ETF 与近 20 日资金的方向也偏强。不过，收盘价仍略低于 MA20 的 33.04，因此结论保留“震荡”二字。若价格跌破近 20 日低点 30.97 或 MA60 的 30.02，这一判断失效。

![两只股票最近约 120 个交易日的日 K 与均线](assets/chapter9/9-4-04-stock-analysis-charts-v2.png){width=96%}
