...
![“技术编辑”创建完成，回复列出配置文件和审阅规则](assets/chapter3/3-1-05-tech-editor-created.png){width=56%}
...
![“技术编辑”读取文档后给出两项具体改进建议](assets/chapter3/3-1-06-tech-editor-review.png){width=42%}
...
![任务面板显示令牌检查完成，正在生成主题载荷和角色 SVG](assets/chapter3/3-2-03-approval-pending.png){width=82%}

### 检查主题效果

![翡翠绿覆盖页面、侧栏和主要控件，右下角显示大幅原创角色](assets/chapter3/3-2-04-theme-result.png){width=96%}
