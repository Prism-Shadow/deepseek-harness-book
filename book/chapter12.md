...
![实际 dump-config 输出中 agent-loop 与 tool-todo 是平等插件](assets/chapter12/12-1-02-plugin-tree-proof.svg){.book-technical-figure width=68%}
...
![dsh 从组合包到用户补丁的分层装配](assets/chapter12/12-1-03-composition-layers.svg){.book-technical-figure width=68%}
...
![官方最小插件从配置到输出的完整路径](assets/chapter12/12-1-04-official-loader-flow.svg){.book-technical-figure width=68%}
...
![同一个能力 seam 可以接入不同提供方](assets/chapter12/12-2-03-capability-seam.svg){.book-technical-figure width=68%}
...
![时间可组合性与空间可组合性](assets/chapter12/12-2-02-spatiotemporal.svg){.book-technical-figure width=68%}
