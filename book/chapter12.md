...
配套示例位于 `demo/chapter12-cordis/12-2-lifecycle`，目录中有四个文件：
...
本书配套目录 `demo/chapter12-cordis/12-3-relations` 已经准备好这两个文件。进入该目录后运行：
...
进入 `demo/chapter12-cordis/12-3-waterfall`，依次执行：
