...
![dsh 完成剧本：单集卡、因果节拍、分场结构一次给出](assets/chapter7/7-1-02-script-written.png){width=68%}
...
![资产设定完成：角色、造型、场景视图、道具状态链与连续性台账](assets/chapter7/7-2-01-assets-done.png){width=68%}
...
![正式分镜：8 个镜头、景别机位、信息差保护与光线线索](assets/chapter7/7-2-02-storyboard.png){width=68%}
...
![第 1 镜完整提示词包含分段动作、机位、光线、声音和结束状态](assets/chapter7/7-2-03-shot1-video-prompt.png){width=68%}
...
![视频提示词：每镜一段完整可交付提示词，含画风与一致性锚点](assets/chapter7/7-2-04-video-prompts.png){width=68%}
...
![全部 8 个分镜生成完成，audit 对账通过](assets/chapter7/7-2-06-all-shots-report.png){width=68%}
