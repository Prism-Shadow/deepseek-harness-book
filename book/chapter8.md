...
![个人能力证据和成果归属](assets/chapter8/8-1-04-ability-evidence-summary.png){width=86%}
...
![针对目标岗位调整后的单页简历](assets/chapter8/8-3-04-final-resume.png){width=58%}
...
“面试复盘.md”是这次求职实测的最后一项核心产物。本次没有继续修改简历或重新导出 PDF，当前的“resume-final.pdf”只能用于模拟面试。实际投递前，还要补入真实个人信息，根据复盘修正简历中有关素材来源、直播结果和涨粉口径的表述，重新核对岗位状态，完成最后检查后再导出“resume-final.pdf”。
