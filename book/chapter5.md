...
![dsh 成功发现并加载 Excel Skill](assets/chapter5/5-1-excel-skill-installed.png){width=62%}
...
![dsh 列出原表中的重复、缺失和格式问题](assets/chapter5/5-1-excel-result.png){width=48%}
...
![Word Skill 已安装到 dsh 的项目级 Skill 目录](assets/chapter5/5-2-word-skill-installed.png){width=52%}
...
![dsh 生成 Word 报告并给出排版检查结果](assets/chapter5/5-2-word-result.png){width=56%}
...
![在 ModLens 中配置 GLM-5V-Turbo](assets/chapter5/5-1-02-glm-5v-turbo-config.png){width=60%}
...
![dsh 通过 ModLens 读取 Word 页面预览](assets/chapter5/5-3-modlens-test.png){width=34%}
...
![PPT Skill 已安装到当前工作区](assets/chapter5/5-3-pptx-skill-installed.png){width=44%}
...
![dsh 完成 6 页演示文稿并保留生成源文件](assets/chapter5/5-3-pptx-result.png){width=46%}

![产品发布会费用复盘演示文稿的六页预览](assets/chapter5/5-3-ppt-preview-overview.png){width=90%}
...
![本节使用的 13 份扫描和拍照 PDF](assets/chapter5/5-4-01-pdf-source-overview.png){width=92%}
...
![dsh 完成 PDF 批量读取并列出核查结果](assets/chapter5/5-4-02-pdf-result.png){width=42%}
...
![dsh 复核页面方向并更新两份交付文件](assets/chapter5/5-4-03-pdf-correction.png){width=42%}
