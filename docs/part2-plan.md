...
状态：**已执行完毕，仅作存档**。2026-08-17 目录调整后第二部分扩为三章，原第 8 章的"一切皆插件"移为 9.1，其后补上 Cordis 核心组成、能力 Seam、设计原理三节，安全边界独立为第 10 章。原 8.3/8.4/8.5 现为 8.2/8.3/8.4。本文记录的是当初的规划思路和源码出处，节号已不对应正文。
